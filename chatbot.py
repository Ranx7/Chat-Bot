...
def corpus_answer(user_input):
    ...
    if best_score < 0.2:
        return "I'm not sure about that. Try rephrasing or switch to mode 2 (web search)."
    return qa_data[best_idx]["answer"]



# Web Search (Mode 2) - Serper API
...
def ask():
    ...
    if mode == "corpus":
        ...
        response = corpus_answer(user_input)

    
    # Mode 2: Serper Web Search
...
# OPTIONAL: A direct endpoint for stats
